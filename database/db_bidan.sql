...
CREATE TABLE `laporan_rekap_pasien` (`Id_Periksa` varchar(50), `Nama_Pasien` varchar(50), `Alamat` varchar(50), `Tanggal_Periksa` timestamp, `No_Pasien` int(11), `umur` bigint(21), `Tinggi_Badan` varchar(37), `Berat_Badan` varchar(37), `Keluhan` text, `Diagnosa ANC` varchar(31), `Tensi` varchar(40), `obat` text, `Total_Bayar` decimal(64,0));
