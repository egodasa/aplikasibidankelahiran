...
Public Class lap_kehamilan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_kehamilan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_kehamilan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_kehamilan = New lap_kehamilan()
        rpt.Site = Me.Site
        Return rpt
    End Function
