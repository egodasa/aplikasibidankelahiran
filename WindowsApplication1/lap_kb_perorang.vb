...
Public Class lap_kb_perorang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_kb_perorang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_kb_perorang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_kb_perorang = New lap_kb_perorang()
        rpt.Site = Me.Site
        Return rpt
    End Function
