...
Public Class lap_tahunan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_tahunan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_tahunan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_tahunan = New lap_tahunan()
        rpt.Site = Me.Site
        Return rpt
    End Function
