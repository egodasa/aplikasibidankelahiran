...
Public Class cetakberobat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.cetakberobat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetakberobat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetakberobat = New cetakberobat()
        rpt.Site = Me.Site
        Return rpt
    End Function
