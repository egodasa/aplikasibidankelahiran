...
Public Class lap_berobat_umum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_berobat_umum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_berobat_umum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_berobat_umum = New lap_berobat_umum()
        rpt.Site = Me.Site
        Return rpt
    End Function
