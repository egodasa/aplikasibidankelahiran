...
Public Class lap_pemasukan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_pemasukan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tahun12() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedlap_pemasukan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_pemasukan = New lap_pemasukan()
        rpt.Site = Me.Site
        Return rpt
    End Function
