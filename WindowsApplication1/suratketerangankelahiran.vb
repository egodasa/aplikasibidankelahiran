...
Public Class suratketerangankelahiran
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "suratketerangankelahiran.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.suratketerangankelahiran.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_kelahiran() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedsuratketerangankelahiran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As suratketerangankelahiran = New suratketerangankelahiran()
        rpt.Site = Me.Site
        Return rpt
    End Function
