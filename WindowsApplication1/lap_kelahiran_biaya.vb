...
Public Class lap_kelahiran_biaya
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "lap_kelahiran_biaya.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_kelahiran_biaya.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_kelahiran_biaya
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_kelahiran_biaya = New lap_kelahiran_biaya()
        rpt.Site = Me.Site
        Return rpt
    End Function
