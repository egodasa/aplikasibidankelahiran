...
Public Class lap_berobat_umum_biaya
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "lap_berobat_umum_biaya.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lap_berobat_umum_biaya.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_berobat_umum_biaya
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_berobat_umum_biaya = New lap_berobat_umum_biaya()
        rpt.Site = Me.Site
        Return rpt
    End Function
